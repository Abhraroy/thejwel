    ...
    >
      ...
      <div className="relative w-full aspect-[2/3] bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
        ...
        {discountPercentage > 0 && (
          <div className="absolute top-2 left-2 md:top-3 md:left-3 bg-gradient-to-r from-rose-500 to-pink-600 text-white text-[10px] md:text-xs font-bold px-2 py-1 md:px-3 md:py-1.5 rounded-full shadow-lg transform transition-all duration-300 hover:scale-110">
